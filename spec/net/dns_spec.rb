...
describe RightSupport::Net::DNS do
  ...
  context :resolve do
    context 'given a DNS hostname' do
    ...
    context 'given an IPv4 address' do
    ...
    context 'given a URI without an authority' do
    ...
    context 'given several hostnames' do
    ...
    context 'given several HTTP URLs' do
